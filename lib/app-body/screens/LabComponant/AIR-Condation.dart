...
class AirCondation extends StatelessWidget {
  const AirCondation({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    bool airConditionStatus = context.watch<DevicesProvider>().airCondtion;
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("statue:${airConditionStatus ? "on" : "off"}"),

                        ///the button
                        FlutterSwitch(
                          value: airConditionStatus,
                          width: 150.0,
                          height: 70.0,
                          toggleSize: 50.0,
                          borderRadius: 30.0,
                          ...
                          onToggle: (val) {
                            context
                                ...
                                .SetChanges(Consts.AIR_CONDITION, val);
                          },
                        ),
                      ],
                    ),
